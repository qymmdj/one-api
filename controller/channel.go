...
func GetAllChannels(c *gin.Context) {
	...
	if keyword != "" {
		channels, err = model.SearchChannelsWithKeyword(keyword, searchType, p*config.ItemsPerPage, config.ItemsPerPage)
		total, _ = model.CountChannelsWithKeyword(keyword, searchType)
	} else {
